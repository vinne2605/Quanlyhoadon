...
namespace HuynhNhatVien_206.Migrations
{
    ...
    [Migration("20240306012533_csdl_thuephong")]
    partial class csdl_thuephong
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HuynhNhatVien_206.Chitietphieuthue", b =>
                {
            ...
            modelBuilder.Entity("HuynhNhatVien_206.Khachthue", b =>
                {
            ...
            modelBuilder.Entity("HuynhNhatVien_206.Loaiphong", b =>
                {
            ...
            modelBuilder.Entity("HuynhNhatVien_206.Phieuthue", b =>
                {
                    b.Property<string>("Sopt")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("HuynhNhatVien_206.Phong", b =>
                {
                    b.Property<string>("Maphong")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("HuynhNhatVien_206.Chitietphieuthue", b =>
                {
                    b.HasOne("HuynhNhatVien_206.Phong", "MaphongNavigation")
                        .WithMany("Chitietphieuthues")
                        .HasForeignKey("Maphong")
                        .IsRequired()
                        .HasConstraintName("FK_chitietphieuthue_phong");

                    b.HasOne("HuynhNhatVien_206.Phieuthue", "SoptNavigation")
                        .WithMany("Chitietphieuthues")
                        .HasForeignKey("Sopt")
                        .IsRequired()
            ...
            modelBuilder.Entity("HuynhNhatVien_206.Phieuthue", b =>
                {
                    b.HasOne("HuynhNhatVien_206.Khachthue", "MakhNavigation")
                        .WithMany("Phieuthues")
                        .HasForeignKey("Makh")
            ...
            modelBuilder.Entity("HuynhNhatVien_206.Phong", b =>
                {
                    b.HasOne("HuynhNhatVien_206.Loaiphong", "MaloaiNavigation")
                        .WithMany("Phongs")
